...
const layerConfigurations = [
  {
    ...
    layersOrder: [
      { name: "Backgrounds" },
      { name: "Boy Skin Tones" },
      { name: "Boy Face Expressions" },
      { name: "Boy Headwear" },
      { name: "Boy Shirts" },
      { name: "Boy Suit Jackets" },
      { name: "Lapel Pin" },
      { name: "Boy Ties" },
      { name: "Boy Handkerchief" },
      { name: "Boy Glasses" },
      { name: "Boy Earrings" },
    ],
  },
  {
    ...
    layersOrder: [
      { name: "Backgrounds" },
      { name: "Girl Skin Tones" },
      { name: "Girl Face Expressions" },
      { name: "Girl Headwear" },
      { name: "Girl Shirts" },
      { name: "Girl Necklaces" },
      { name: "Girl Scarves:Coats" },
      { name: "Girl Earrings" },
    ],
  },
];
...
const extraMetadata = {
  external_url: "https://www.greenwoodistrictsociety.com", // Replace with your website or remove this line if you do not have one.
};
...
const PUBLIC_MINT_START_DATE = "2022-05-08T16:00:00+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x48631c6281c2BC4bD4b2d52Ab4b0DE323a22B8ee"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Which Greenwood Townsperson Will You Get?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeif3hu6cxggqouylpqzedkmelsbdbsj3lx27cfea6dq66a4dki4qyy"; // Replace with your generic image that will display for all NFTs pre-reveal.
